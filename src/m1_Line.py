...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.cc = 0
        self.ostart = self.start.clone()
        self.oend = self.end.clone()
    def __repr__(self):
        """
        What comes in:
          -- self
    ...
    def length(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        dist = math.sqrt((self.end.x-self.start.x)**2+
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        p1 = Point(self.start.x+other_line.start.x,
              self.start.y+other_line.start.y)
        p2 = Point(self.end.x+other_line.end.x,
