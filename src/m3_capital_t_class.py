...
class CapitalT(object):
    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def move_by(self, dx, dy):
        ...
        # ---------------------------------------------------------------------
        #self.h_rect = rg.Rectangle(rg.Point(self.h_rect.get_lower_left_corner().x +
                                            #dx,self.h_rect.get_lower_left_corner().y +dy),
                                   #rg.Point(self.h_rect.get_upper_right_corner().x +dx,
                                            #self.h_rect.get_upper_right_corner().y +dy))
        #self.v_rect = rg.Rectangle(rg.Point(self.v_rect.get_lower_left_corner().x +
                                            #dx, self.v_rect.get_lower_left_corner().y + dy),
                                  # rg.Point(self.v_rect.get_upper_right_corner().x + dx,
                                         #   self.v_rect.get_upper_right_corner().y + dy))
    ...
    def clone(self):
        ...
        #######################################################################
        return CapitalT(rg.Point(self.h_rect.get_center().x,self.h_rect.get_center().y),
                        self.h_rect.get_upper_right_corner().x-self.h_rect.get_lower_left_corner().x,
                        self.v_rect.get_lower_left_corner().y-self.v_rect.get_upper_right_corner().y,
                        self.h_rect.get_lower_left_corner().y-self.h_rect.get_upper_right_corner().y)
# -----------------------------------------------------------------------------
